...
Widgets that accept user input, primarily those bound to dollar variables.
"""
...
class DollarVariableLineEdit(ThemedLineEdit):
    ...
    def __init__(self, variable_name: str, main_window: Optional[Any] = None, parent=None):
...
class DollarVariableCheckBox(ThemedCheckBox):
    ...
    def __init__(self, variable_name: str, text: str = "", main_window: Optional[Any] = None, parent=None):
...
class DollarVariableRadioGroup:
    ...
    def __init__(self, variable_name: str, main_window: Optional[Any] = None):
        self.variable_name = variable_name
        self.main_window = main_window
